...
walks through a fixed sequence of steps. trialSize has one function for each:
...
If you use trialSize in your research, please cite the underlying methods (see
